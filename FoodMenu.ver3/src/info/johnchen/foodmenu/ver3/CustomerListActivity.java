...
/**
 * An activity representing a list of Customers. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link CustomerDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link CustomerListFragment} and the item details (if present) is a
 * {@link CustomerDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link CustomerListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class CustomerListActivity extends FragmentActivity implements
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.customer_detail_container, fragment).commit();
