...
public class CustomerDetailFragment extends Fragment {
	 ...
	 */
	private CustomerContent.CustomerItem mItem;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments().containsKey(ARG_ITEM_ID)) {
			...
			mItem = CustomerContent.ITEM_MAP.get(getArguments().getString(
					ARG_ITEM_ID));
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (mItem != null) {
			((TextView) rootView.findViewById(R.id.customer_detail))
					.setText("Phone Number: " + mItem.phoneNumber + 
							"\n\nAddress: " + mItem.address + 
							"\n\nCC Number: " + mItem.creditCard +
							"\n\nOrder: " + mItem.order + 
							"\n\nPrice: $" + mItem.price);
		}
